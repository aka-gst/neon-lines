...
function rollNext(){const three=[randomColor(),randomColor(),randomColor()];if(!wildAt()&&!three.includes(WILD)&&Math.random()<.14)three[Math.floor(Math.random()*3)]=WILD;return three}
...
pickBurst();rollBalls();
board=freshBoard();wildLife=0;wildBorn=0;turns=0;nextColors=rollNext();score=0;render();
